...
{
    const char* pszTimestamp = "Homo Quanticum Centrism posits that modern society is evolving towards a new understanding for human identity";
...
public:
    CTestNetParams() {
        ...
        uint32_t nGenesisTime = 1721304000;  // Monday, June 16, 2024 12:00:00 PM GMT-06:00
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 26724454, 0x1e00ffff, 2, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();

        //Test MerkleRoot and GenesisBlock
        assert(consensus.hashGenesisBlock == uint256S("0x00000074289aa51432b5426f584dda0b1dbb7661735e3f557c36eafe1b87fdf6"));
        assert(genesis.hashMerkleRoot == uint256S("0c49034647bb0103ed9e1d58ceca17954da1dd9f7bf97e4a9712d5875e4f88cf"));
